        ...
        child: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              // Cap artwork so it never dominates the layout on landscape/desktop.
              // On portrait phones width*0.85 is the natural constraint;
              // on landscape desktops height*0.40 kicks in instead.
              final artSize = min(
                availableWidth * 0.85,
                availableHeight * 0.40,
              );
              // Proportional spacing — scales down gracefully on small heights.
              final spacerH = availableHeight * 0.025;
              ...
              return Column(
                children: [
                  ...
                  SizedBox(height: spacerH.clamp(8, 32)),
